...
- **package:** [main](./link-checker) (``113 lines``)

### [distributed map reduce](./mapreduce) — ``599 lines``
build a fault tolerant distributed mapreduce system

- **summary:** [mapreduce/mapreduce.md](./mapreduce/mapreduce.md)
- **package:** [main](./mapreduce) (``36 lines``)
- **package:** [mr](./mapreduce/mr) (``534 lines``)
- **package:** [wordcount](./mapreduce/apps/wordcount) (``29 lines``)
...
- **package:** [main](./news-summary) (``124 lines``)
...
- **package:** [main](./wikipedia-mapreduce) (``226 lines``)
